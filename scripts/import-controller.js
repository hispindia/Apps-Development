                ...
                workbook.SheetNames.forEach(function (sheetName) {
                    ...
                    if( sheetName === 'event' ){
                        ...
                        XL_row_object.forEach(row => {
                            ...
                            $.ajax({
                                ...
                                success: function (response) {
                                    //console.log( __rowNum__ + " -- "+ row.event + "Event updated with " + row.value + "response: " + response );
                                    console.log( "Row - " + importCount + JSON.stringify(row) + " delete event " + row.event + " response: " + JSON.stringify(response) );
                                },
                                error: function (response) {
                                    console.log(  "Row - " + importCount + JSON.stringify(row) +  " not deleted event " + row.event + " response: " + JSON.stringify(response ));
                                },
                                warning: function (response) {
                                    console.log( "Row - " + importCount + JSON.stringify(row ) +  " -- "+ "Warning!: " +  JSON.stringify(response ) );
                                }
                    ...
                    // post event from one instance to another instance event to event post
                        ...
                        XL_row_object.forEach(row => {
                            ...
                            $.ajax({
                                ...
                                success: function (eventResponse) {
                                    ...
                                    $.ajax({
                                        ...
                                        url: 'https://links.hispindia.org/myanmarhmis/api/events/',
                                        ...
                                        error: function (response) {
                                            console.log(  JSON.stringify(row) +  " event not post for " + row.uid + " response: " + JSON.stringify(response ));
                                        },
                                        warning: function (response) {
                                            console.log( JSON.stringify(row ) +  " -- "+ "Warning!: " +  JSON.stringify(response ) );
                                        }
                            ...
                            importCount++;
                            console.log( "Row - " + importCount + " event post from one instance to other done for event " + row.event );
                            if( importCount === parseInt(XL_row_object.length) + 1 ){
                                console.log( " event post event post from one instance to other done ");
                    ...
                    // event Post with multiple dataValue
                    ...
                    else if( sheetName === 'eventPostMultipleDataValues' ){
                        let XL_row_object = XLSX.utils.sheet_to_row_object_array(workbook.Sheets[sheetName]);
                        //let json_object = JSON.stringify(XL_row_object);
                        let objectKeys = Object.keys(XL_row_object["0"]);
                        //console.log("objectKeys : " + objectKeys );
                        ...
                        for(let row = 0; row < XL_row_object.length; row++) {
                            ...
                            for (let i = 7; i < objectKeys.length; i++) {
                                let eventDataValue = {};
                                if (XL_row_object[row][objectKeys[i]] !== undefined && XL_row_object[row][objectKeys[i]] !== "") {
                                    eventDataValue.dataElement = objectKeys[i];
                                    eventDataValue.value = XL_row_object[row][objectKeys[i]];
                                    eventDataValues.push(eventDataValue);
                                }
                            }
                    ...
                    // events Delete delete
                    else if( sheetName === 'eventsDelete' ){
                        var XL_row_object = XLSX.utils.sheet_to_row_object_array(workbook.Sheets[sheetName]);
                        //var json_object = JSON.stringify(XL_row_object);
                        //var objectKeys = Object.keys(XL_row_object["0"]);
                        let deleteCount = 1;
                        XL_row_object.forEach(row => {
                            ...
                            //console.log( "Row - " + importCount + " update done for event " + row.event );
                            if( deleteCount === parseInt(XL_row_object.length) + 1 ){
                                console.log( " events delete done ");
                            }
                        });
                    ...
                    // for TEI Coordinate and featureType update
                    else if( sheetName === 'teiCoordinateUpdate' ){
                        let XL_row_object = XLSX.utils.sheet_to_row_object_array(workbook.Sheets[sheetName]);
                        let json_object = JSON.stringify(XL_row_object);
                        let objectKeys = Object.keys(XL_row_object["0"]);
                        let importCount = 1;
                        XL_row_object.forEach(row => {
                            ...
                            $.ajax({
                                type: "GET",
                                async: false,
                                url: '../../trackedEntityInstances/' + row.tei + ".json?paging=false",
                                success: function (trackedEntityInstancesResponse) {

                                    var updateTEIGeometry = trackedEntityInstancesResponse;
                                    updateTEIGeometry.featureType = 'POINT';
                                    updateTEIGeometry.geometry = {
                                    ...
                                    $.ajax({
                                        ...
                                        async: false,
                                        contentType: "application/json",
                                        data: JSON.stringify(updateTEIGeometry),
                                        url: '../../trackedEntityInstances/' + row.tei,
                            ...
                            console.log( "Row - " + importCount + " update done for TEI Coordinate " + row.tei );
                            if( importCount === parseInt(XL_row_object.length) + 1 ){
                                console.log( " update done ");
                    ...
                    // programIndicators attributeValues update
                    else if( sheetName === 'piAttributeValueUpdate' ){
                        var XL_row_object = XLSX.utils.sheet_to_row_object_array(workbook.Sheets[sheetName]);
                        var json_object = JSON.stringify(XL_row_object);
                        var objectKeys = Object.keys(XL_row_object["0"]);
                        var updateCount = 1;
                        XL_row_object.forEach(row => {
                            ...
                            $.ajax({
                                ...
                                url: '../../programIndicators/' + row.uid + ".json?paging=false",
                                success: function (programIndicatorResponse) {
                                    var updateProgramIndicator = programIndicatorResponse;


                                    var programIndicatorAttributeValue = [...programIndicatorResponse.attributeValues];

                                    programIndicatorAttributeValue.push({
                                    ...
                                    updateProgramIndicator.attributeValues = programIndicatorAttributeValue;
                                    ...
                                    $.ajax({
                                        ...
                                        dataType: "json",
                                        contentType: "application/json",
                                        data: JSON.stringify(updateProgramIndicator),
                                ...
                                success: function (orgUnitResponse) {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (orgUnit2Response) {
                                            ...
                                            tempOrgUnitResponse = orgUnit2Response;
                                            tempOrgUnitResponse.geometry = updateOrgUnitGeometry
                    ...
                    // end orgUnit geometry update from one instance to another instance


                    // orgUnit geometry update set null
                    else if( sheetName === 'orgUnitCoordinateNull' ){
                        var XL_row_object = XLSX.utils.sheet_to_row_object_array(workbook.Sheets[sheetName]);
                        var json_object = JSON.stringify(XL_row_object);
                        var objectKeys = Object.keys(XL_row_object["0"]);
                        var importCount = 1;
                    ...
                    else if( sheetName === 'orgUnitGeometryUpdate_232' ){
                        var XL_row_object = XLSX.utils.sheet_to_row_object_array(workbook.Sheets[sheetName]);
                        var json_object = JSON.stringify(XL_row_object);
                        var objectKeys = Object.keys(XL_row_object["0"]);
                        var importCount = 1;
                    ...
                    // organisationUnits code update
                    else if( sheetName === 'organisationUnitCodeUpdate' ){
                        var XL_row_object = XLSX.utils.sheet_to_row_object_array(workbook.Sheets[sheetName]);
                        var json_object = JSON.stringify(XL_row_object);
                        var objectKeys = Object.keys(XL_row_object["0"]);
                        var importCount = 1;
                    ...
                    // indicator post
                    else if( sheetName === 'indicatorsPost' ){
                        var XL_row_object = XLSX.utils.sheet_to_row_object_array(workbook.Sheets[sheetName]);
                        //var json_object = JSON.stringify(XL_row_object);
                        //var objectKeys = Object.keys(XL_row_object["0"]);
                        let importCount = 1;
                        XL_row_object.forEach(row => {
                            ...
                            let indicatorPostRequest = {
                                id : row.uid,
                                name: row.name,
                                shortName: row.shortName,
                                numerator:row.numerator,
                                denominator: row.denominator,
                                numeratorDescription: row.name,
                                denominatorDescription : row.name,
                                indicatorType: {id: row.indicatorType}
                            ...
                            $.ajax({
                                ...
                                dataType: "json",
                                contentType: "application/json",
                                data: JSON.stringify(indicatorPostRequest),
                                url: '../../indicators',
                                success: function (response) {
                                    //console.log( __rowNum__ + " -- "+ row.event + "Event updated with " + row.value + "response: " + response );
                                    console.log( "Row - " + importCount  + " response: " + JSON.stringify(response) );
                    ...
                    // dataElement categoryOption sharing-setting update
                    else if( sheetName === 'deCategoryOptionSharingPost' ){
                        var XL_row_object = XLSX.utils.sheet_to_row_object_array(workbook.Sheets[sheetName]);
                        var json_object = JSON.stringify(XL_row_object);
                        var objectKeys = Object.keys(XL_row_object["0"]);
                        var importCount = 1;
                        XL_row_object.forEach(row => {
                            ...
                            $.ajax({
                                type: "GET",
                                async: false,
                                url: '../../sharing.json?type=categoryOption&id=' + row.uid,
                                success: function (deCOResponse) {
                                    var deCategoryOptionSharingResponse = deCOResponse;

                                    let deCategoryOptionSharingPostRequest = {
                                        meta : deCategoryOptionSharingResponse.meta,
                                        meta : deCategoryOptionSharingResponse.meta,
                                        object : {
                                            id: deCategoryOptionSharingResponse.object.id,
                                            name: deCategoryOptionSharingResponse.object.name,
                                            displayName: deCategoryOptionSharingResponse.object.displayName,
                                            user: deCategoryOptionSharingResponse.object.user,
                                            externalAccess: deCategoryOptionSharingResponse.object.externalAccess,
                                    ...
                                    $.ajax({
                                        ...
                                        dataType: "json",
                                        contentType: "application/json",
                                        data: JSON.stringify(deCategoryOptionSharingPostRequest),
                                        url: '../../sharing.json?type=categoryOption&id=' + row.uid,
                    ...
                    // indicator numerator/denominator update
                    else if( sheetName === 'indicatorNumDenoUpdate' ){
                        var XL_row_object = XLSX.utils.sheet_to_row_object_array(workbook.Sheets[sheetName]);
                        var json_object = JSON.stringify(XL_row_object);
                        var objectKeys = Object.keys(XL_row_object["0"]);
                        var importCount = 1;
                    ...
                    /*
                         ...
                         $.ajax({
                             type: "POST",
                             async: false,
                             dataType: "json",eventToEventPush
                             contentType: "application/json",
                             data: dataJSON,
                             url: '../../dataValueSets',
                    ...
                    // optionSet  PUT update

                    // programIndicators name update
                    else if( sheetName === 'optionsSortOrderUpdate' ){
                        var XL_row_object = XLSX.utils.sheet_to_row_object_array(workbook.Sheets[sheetName]);
                        var json_object = JSON.stringify(XL_row_object);
                        var objectKeys = Object.keys(XL_row_object["0"]);
                        var updateCount = 1;
                        XL_row_object.forEach(row => {
                            ...
                            $.ajax({
                                type: "GET",
                                async: false,
                                url: '../../optionSets/' + row.uid + ".json?paging=false",
                                success: function (optionSetsResponse) {
                                    var updateOptionSetOptionsSortOrder = optionSetsResponse;
                                    ...
                                    $.ajax({
                                        ...
                                        dataType: "json",
                                        contentType: "application/json",
                                        data: JSON.stringify(updateOptionSetOptionsSortOrder),

                                        url: '../../optionSets/' + row.uid + "?mergeMode=REPLACE",
                                        success: function (putResponse) {
                                            //console.log( __rowNum__ + " -- "+ row.event + "Event updated with " + row.value + "response: " + response );
                                            console.log(  "Row - " + updateCount + " update done response: " + JSON.stringify(putResponse) );
                                        },
                                ...
                                error: function (updateOptionSetSortOrder) {
                                    console.log( JSON.stringify( row.uid ) +  " -- "+ "Error!: " +  JSON.stringify( updateOptionSetSortOrder ) );
                                },
                                warning: function (updateOptionSetSortOrder) {
                                    console.log( JSON.stringify( row.uid ) +  " -- "+ "Error!: " +  JSON.stringify( updateOptionSetSortOrder ) );
                                }
                            });
                            //console.log( "Row - " + importCount + " update done for organisationUnit " + row.uid );
                            if( updateCount === parseInt(XL_row_object.length) + 1 ){
                                console.log( " update optionSetSortOrder complete ");
                            }
                        });
                    }
                    ...
                    // optionSetsPost post with optionsPostWithAttributeValue
                    else if( sheetName === 'optionsPostWithAttributeValue' ){
                        var XL_row_object = XLSX.utils.sheet_to_row_object_array(workbook.Sheets[sheetName]);
                        //var json_object = JSON.stringify(XL_row_object);
                        //var objectKeys = Object.keys(XL_row_object["0"]);
                        let importCount = 1;
                    ...
                    // categories post without categoryOptions
                    else if( sheetName === 'categoriesPostWithOutOption' ){
                        var XL_row_object = XLSX.utils.sheet_to_row_object_array(workbook.Sheets[sheetName]);
                        var json_object = JSON.stringify(XL_row_object);
                        var objectKeys = Object.keys(XL_row_object["0"]);
                        var importCount = 1;
                        ...
                        XL_row_object.forEach(row => {
                            ...
                            let categoryPostRequest = {
                                ...
                                shortName: row.shortName,
                                code: row.code,
                                dataDimensionType :row.dataDimensionType,
                                dataDimension : row.dataDimension
                            };
                    ...
                    // trackedEntityAttributes  post
                    else if( sheetName === 'trackedEntityAttributesPost' ){
                        var XL_row_object = XLSX.utils.sheet_to_row_object_array(workbook.Sheets[sheetName]);
                        //var json_object = JSON.stringify(XL_row_object);
                        //var objectKeys = Object.keys(XL_row_object["0"]);
                        let importCount = 1;
                    ...
                    // dataElementPost post
                        ...
                        XL_row_object.forEach(row => {
                            ...
                            let dataElementPostRequest = {
                                ...
                                publicAccess: row.publicAccess,
                                sharing: { public:  row.publicAccess },
                                legendSets: []
                            };
                    ...
                    // dataElements  code update
                    else if( sheetName === 'dataElementsCodeUpdate' ){
                        var XL_row_object = XLSX.utils.sheet_to_row_object_array(workbook.Sheets[sheetName]);
                        var json_object = JSON.stringify(XL_row_object);
                        var objectKeys = Object.keys(XL_row_object["0"]);
                        var importCount = 1;
                        XL_row_object.forEach(row => {
                            ...
                            $.ajax({
                                ...
                                success: function (dataElementResponse) {
                                    ...
                                    updateDataElement.id = row.uid;
                                    updateDataElement.code = row.code;
                    ...
                    // dataElements  publicaccess/sharing-setting update from 2.41
                    else if( sheetName === 'dataElementPublicAccessUpdate' ){
                        var XL_row_object = XLSX.utils.sheet_to_row_object_array(workbook.Sheets[sheetName]);
                        var json_object = JSON.stringify(XL_row_object);
                        var objectKeys = Object.keys(XL_row_object["0"]);
                        var importCount = 1;
                        XL_row_object.forEach(row => {
                            ...
                            $.ajax({
                                ...
                                success: function (dataElementResponse) {
                                    ...
                                    updateDataElement.id = row.uid;
                                    updateDataElement.sharing.public = row.publicAccess;
                            ...
                            $.ajax({
                                ...
                                success: function (userResponse) {
                                    ...
                                    if( row.userGroups !== undefined  && row.userGroups !== "" ){
                                        ...
                                        updateUser.userGroups = userGroups;
                                    }
                                    if( row.organisationUnits !== undefined  && row.organisationUnits !== "" ){
                                    ...
                                    if( row.userRoles !== undefined  && row.userRoles !== "" ){
                                        ...
                                        updateUser.userCredentials.userRoles = userRoles;
                                    }
                    ...
                    //users Update users Update Disabled true
                    else if( sheetName === 'usersUpdateDisabled' ){
                        var XL_row_object = XLSX.utils.sheet_to_row_object_array(workbook.Sheets[sheetName]);
                        var json_object = JSON.stringify(XL_row_object);
                        var objectKeys = Object.keys(XL_row_object["0"]);
                        var importCount = 1;
                        XL_row_object.forEach(row => {
                            ...
                            $.ajax({
                                ...
                                url: '../../users/' + row.uid + ".json?paging=false",
                                success: function (userResponse) {
                                    let updateUsersDisabled = userResponse;

                                    updateUsersDisabled.disabled = row.disabled;
                                    ...
                                    $.ajax({
                                        ...
                                        dataType: "json",
                                        contentType: "application/json",
                                        data: JSON.stringify(updateUsersDisabled),
                                        url: '../../users/' + row.uid,
