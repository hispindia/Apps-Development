...
export const setLanguage = payload => dispatch => dispatch(createAction(SET_LANGUAGE, payload));
export const translationDataElements = payload => dispatch => dispatch(createAction(TRANSLATION_DATAELEMENTS, payload));
export const dateDataElements = payload => dispatch => dispatch(createAction(DATETYPE_DATAELEMENTS, payload));
