import { GET_ORG_UNITS_DETAIL, METADATA_RECEIVED, SET_PAYLOAD, SET_DATA_VALUES, SET_TEI_ATTRIBUTE, TRACKED_ENTITY_RECEIVED,
   CHECKED_VALIDATION, EVENT_FAILURE, DYNAMIC_RECEIVED_DATA, PROGRAMS_RECEIVED, PROGRAMSTAGE_RECEIVED, PROGRAMSTAGE_SECTIONS_RECEIVED,SET_MENDATORY_DATAELEMENTS,
    UPDATE_EVENT_VALUES,RESET_FORM, SET_PROGRAM_RULES, PROGRAM_RULE_MERGE, EVENT_POST, RESET,LOADING_PAGE,FETCH_CONDITIONAL_OU, SET_PROGRAM_RULES_CONDITION, CHECK_MANDATORY,TRANSLATION_DATAELEMENTS,SET_LANGUAGE, DATETYPE_DATAELEMENTS } from '../action';
const INITIAL_EVENT = {
  values: null,
  programStage: null,
  status: {},
