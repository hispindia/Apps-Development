...
<head>
    <style>
        ...
        .input_back:hover,
        .input_back:hover:before {
            background: #00FF99;
            content: 'Add ';
        }

        .input_back.selectedReport:hover,
        .input_back.selectedReport:hover:before {
            background: #FF6633;
            content: 'Remove ';
        }
    ...
    <link type="text/css" rel="stylesheet"
        href="../../../dhis-web-commons/font-awesome/css/font-awesome.min.css?_rev=19841" />
    <link type="text/css" rel="stylesheet" media="screen"
        href="../../../dhis-web-commons/javascripts/jQuery/ui/css/redmond/jquery-ui.css?_rev=19841" />
    <link type="text/css" rel="stylesheet" media="screen,print"
        href="../../../dhis-web-commons/css/green/green.css?_rev=19841" />
    <link type="text/css" rel="stylesheet" media="screen,print"
        href="../../../dhis-web-commons/css/widgets.css?_rev=19841" />
    ...
    <link type="text/css" rel="stylesheet" media="screen"
        href="../../../dhis-web-commons/javascripts/jQuery/calendars/css/jquery.calendars.picker.css?_rev=19841" />
    ...
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/jQuery/jquery.utils.js?_rev=19841"></script>
    <script type="text/javascript" src="../../../dhis-web-commons/javascripts/jQuery/jquery.ext.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/jQuery/jquery.metadata.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/jQuery/jquery.tablesorter.min.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/jQuery/jquery.upload-1.0.2.min.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/jQuery/jquery.dhisAjaxSelect.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/jQuery/ui/jquery-ui.min.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/jQuery/ui/jquery.blockUI.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/jQuery/jquery.validate.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/jQuery/jquery.validate.ext.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/jQuery/jquery.cookie.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/jQuery/jquery.glob.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/jQuery/jquery.date.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/jQuery/jquery.tmpl.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/jQuery/jquery.autogrow.js?_rev=19841"></script>
    ...
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/dhis2/dhis2.select.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/jQuery/calendars/jquery.calendars.min.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/jQuery/calendars/jquery.calendars.plus.min.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/dhis2/dhis2.period.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/jQuery/calendars/jquery.calendars.picker.min.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/dhis2/dhis2.selected.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/dhis2/dhis2.comparator.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/dhis2/dhis2.availability.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/dhis2/dhis2.trigger.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/dhis2/dhis2.sharing.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/dhis2/dhis2.validation.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/dhis2/dhis2.storage.ss.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/dhis2/dhis2.storage.ls.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/dhis2/dhis2.storage.idb.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/dhis2/dhis2.storage.memory.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/dhis2/dhis2.storage.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/dhis2/dhis2.contextmenu.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/dhis2/dhis2.appcache.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/dhis2/dhis2.translate.js?_rev=19841"></script>
    <script type="text/javascript" src="../../../dhis-web-commons/javascripts/dhis2/dhis2.menu.js?_rev=19841"></script>
    <script type="text/javascript"
        src="../../../dhis-web-commons/javascripts/dhis2/dhis2.menu.ui.js?_rev=19841"></script>
    ...
    <script type="text/javascript">
        ...
        function printReport() {
            ...
            for (var t = 0; t < selectedReportsId.length; t++) {
                ...
                if (rid != "deleted") {
					var url = "../../../dhis-web-reports/index.html#/standard-report/view/" + rid + "?&ou=" + oid + "&period=" + perd + "&rdur=" + rdur + "";
					window.open(url);
                }
            }
        }
        ...
        function getUidOrNameOfTheReport(divId, uidOrName) {
            ...
            else if (divId == 'rawNutritionIMAM') { reportId = "boqlyajWLHH"; value = "rawNutritionIMAM"; }
            ...
            else if (divId == 'rawTbDR') { reportId = "wBeQUggMAGs"; value = "TuberculosisDR"; }

            else if (divId == 'rawHIV') { reportId = "PpfpfQE5ZDX"; value = "HIV(T&C)"; }

            else if (divId == 'rawHIVPMTCT') { reportId = "GfhHNMVIn4g"; value = "HIV(PMTCT)"; }
            else if (divId == 'rawHIVSTI') { reportId = "zfddjcfc5g4"; value = "HIV(STI)"; }
            else if (divId == 'rawHIVART') { reportId = "Pfyc0DlQ4E8"; value = "HIV(ART)"; }
            else if (divId == 'rawHIVOI') { reportId = "tM2CUAcGC2s"; value = "HIV(OI)"; }

            else if (divId == 'rawHospital') { reportId = "S2VVhZaog4l"; value = "Hospital"; }
            else if (divId == 'rawHospitalIO') { reportId = "aHHXI8r6S3i"; value = "Hospital(IO)"; }

            else if (divId == 'rawKala') { reportId = "VdFneF5UDF8"; value = "rawKala"; }
            else if (divId == 'rawMalaria') { reportId = "S49w8dEn2Sr"; value = "rawMalaria"; }
            else if (divId == 'rawFCHV') { reportId = "YUXPhKvaj3d"; value = "rawFCHV"; }
            ...
            else if (divId == 'anaImmunization') { reportId = "JbGiJd2ueNP"; value = "Immunization"; }//11
            ...
            else if (divId == 'anaInpatient_Report') { reportId = "G6RGHanNUpX"; value = "Inpatient_Report"; }

            else if (divId == 'veriFP') { reportId = "JWalcBblOjI"; value = "Family Planning"; }//2
            else if (divId == 'veriPMP') { reportId = "rLzmqMvbj0P"; value = "Population Management Program"; }//3
            else if (divId == 'veriImmunization') { reportId = "KJsnBag12Qj"; value = "Immunization"; }//4
            else if (divId == 'veriFCHV') { reportId = "RUF0i8lGlj0"; value = "FCHV"; }//5
            else if (divId == 'veriGEASID') { reportId = "ILsZOZJSoQ2"; value = "Gender Equity and Social Inclusion Dataset "; }//6
            else if (divId == 'veriHSD') { reportId = "ke8MBi7zEcT"; value = "Hospital Services Dataset"; }//7
            else if (divId == 'veriKA') { reportId = "N4FTzJqjMcp"; value = "Kala-azar Dataset"; }//8
            else if (divId == 'veriLS') { reportId = "l7InD2hcPIs"; value = "Laboratory Services Dataset"; }//9
            else if (divId == 'veriLeprosy') { reportId = "pqyLOoptPiX"; value = "Leprosy Dataset"; }//10
            else if (divId == 'veriMalaria') { reportId = "vitng9hNbwo"; value = "Malaria"; }//11
            else if (divId == 'veriOPD') { reportId = "WcM06liFGW8"; value = "OPD"; }//12
            else if (divId == 'veriPHC') { reportId = "Bv7wlcm9mnY"; value = "Primary Health Care Outreach Clinic Dataset"; }//13
            else if (divId == 'veriSMP') { reportId = "Ztw1pdVqVkW"; value = "Safe Motherhood Program"; }//14
            else if (divId == 'veriNutrition') { reportId = "ikKMWjiRjNJ"; value = "Nutrition"; }//15
            else if (divId == 'veriCBIMCI') { reportId = "AdbvTHqPJIW"; value = "CBIMCI"; }//16
            else if (divId == 'veriHIVAE') { reportId = "lWZ5IShlka5"; value = "HIV/AIDS All Elements"; }//17
            else if (divId == 'veriTAE') { reportId = "GXw3RxTm1lS"; value = "Tubercluosis All Element"; }//18
            else if (divId == 'veriHIVTC') { reportId = "kpysn5n6UJB"; value = "HIV Testing and Counseling"; }//19
            else if (divId == 'veriHIVSTI') { reportId = "CY1jPHaUxqG"; value = "HIV Sexually Transmitted Infection"; }//21
            else if (divId == 'veriAT') { reportId = "ATdjLmbv5TR"; value = "HIV Antiretroviral Treatment"; }//22
            else if (divId == 'veriHIVOI') { reportId = "hTuvgh0LuUe"; value = "HIV / AIDS Opportunistic Infections"; }//25
            else if (divId == 'veriTDRTB') { reportId = "jrxzLJzi57j"; value = "Tuberculosis DR TB"; }//26
            else if (divId == 'veriTuberculosis') { reportId = "JcFLVtbARNI"; value = "Tuberculosis"; }//27
            else if (divId == 'veriTTO') { reportId = "c2VYS5mon62"; value = "Tuberculosis Treatment Outcome"; }//28
            else if (divId == 'veriTPAL') { reportId = "A3YQqY95tYP"; value = "Tuberculosis PAL"; }//29
        ...
        function viewVerReports() {
            ...
            var z = selectedReportsId.length;
            var k = 0;
            for (var t = 0; t < z; t++) {
                if (selectedReportsId[t] != "deleted") {
                    reportId[k] = selectedReportsId[t];
                    k++;
                }
            }
            var smonth = document.getElementById("monthTile").innerHTML;
            var org = document.getElementById("orgTitle").innerHTML;


            finalIds = reportId.join();
            var url = "../dhis-web-reporting/generateHtmlReport.action?uid=BKpe2WpvNmU&pe=" + perd + "&ou=" + oid + "&rdur=" + rdur + "&reportID=" + finalIds + "&strMonth=" + smonth + "orgTitle=" + org;
            window.open(url);
        }
...
<body>
    ...
    <div class="content" id="typeSel" align="center" style="display:block">
        <select id="divShow" onChange="programmechange()" style="position:fixed;top:40%;left:50%;margin-left:-150px">
        ...
        <div id="display" class="display"
            style="display:block;position:fixed;top:40%;left:50%;margin-left:-400px;margin-top:-40px">
            Please select a category to generate reports
        </div>

        <div id="rawdata" class="display" align="left" style="display:none">
            <div class="input_back" id="rawHealth">Reporting Status</div>
            <!-- Name Has been Changed from Hospital Instition To Immunization-->
            <div class="input_back" id="rawEPI">Immunization</div>
            <!-- Name Has been Changed from EPI To Immunization-->
            <div class="input_back" id="rawCBIMCI">CBIMCI</div>
            <div class="input_back" id="rawNutrition">Nutrition</div>

            <div class="input_back" id="rawNutritionIMAM">Nutrition(IMAM)</div>
            <!--ID to be Added-->

            <div class="input_back" id="rawFCHV">FCHV</div>
            <!--ID to be Added-->

            <div class="input_back" id="rawMotherhood"> Safe motherhood</div>
            <div class="input_back" id="rawFamily"> Family Planning</div>
            <div class="input_back" id="rawPHCORC"> PHCORC</div>
            <div class="input_back" id="rawLeprosy"> Leprosy</div>

            <div class="input_back" id="rawMalaria"> Malaria</div>
            <!--ID to be Added-->

            <div class="input_back" id="rawTb"> Tuberculosis</div>

            <div class="input_back" id="rawTbDR"> Tuberculosis(DR)</div>
            <!--ID to be Added-->
            <div class="input_back" id="rawKala"> Kala-azar</div>


            <div class="input_back" id="rawHIV"> HIV(T&C)</div>

            <div class="input_back" id="rawHIVPMTCT"> HIV(PMTCT)</div>
            <!--ID to be Added-->
            <div class="input_back" id="rawHIVSTI"> HIV(STI/OST)</div>
            <!--ID to be Added-->
            <div class="input_back" id="rawHIVART"> HIV(ART)</div>
            <!--ID to be Added-->
            <div class="input_back" id="rawHIVOI"> HIV(OI)</div>
            <!--ID to be Added-->

            <div class="input_back" id="rawGESI">GESI</div>
            <div class="input_back" id="rawOPD"> OPD</div>
            <div class="input_back" id="rawLAB"> Laboratory</div>

            <div class="input_back" id="rawHospital"> Hospital Service</div>

            <div class="input_back" id="rawHospitalIO"> Hospital(Inpatient outcome)</div>


            <!--ID to be Added-->
            <!-- Name Has been Changed from Hospital To Hospital Summary-->

            <div class="parameterBack"
                style="width:220px;background:#87CEFA;text-align:center;cursor:pointer;margin-left:520px;margin-top:20px"
                onclick="viewTree()"> Continue
            </div>
        </div>
        ...
        <div id="analyseddata" class="display" align="left" style="display:none">
            ...
            <div class="input_back" id="anaReporting">Reporting status</div>
            <div class="input_back" id="anaImmunization">Immunization</div>
            <div class="input_back" id="anaCBIMCI">CBIMCI</div>
            <div class="input_back" id="anaNutrition">Nutrition</div>
            <div class="input_back" id="anaFCHV">FCHV</div>
            <div class="input_back" id="anaSM">Safe Motherhood</div>
            <div class="input_back" id="anaPHCORC">PHCORC</div>
            <div class="input_back" id="anaLeprosy">Leprosy</div>
            <div class="input_back" id="anaMalaria">Malaria</div>
            <div class="input_back" id="anaTuberculosis">Tuberculosis</div>
            <div class="input_back" id="anaKala"> Kala-azar</div>
            <div class="input_back" id="anaOPD">OPD</div>
            <div class="input_back" id="anaHMI">Health_Major_Indicators</div>
            <div class="input_back" id="anaHMMI">Hospital_Major_Indicators</div>
            <div class="input_back" id="anaInpatient_Report">Inpatient_Report</div>
        ...
        <div id="verification" class="display" align="left" style="display:none;">

            <div class="input_back" id="veriImmunization"> Immunization</div>
            <div class="input_back" id="veriCBIMCI"> CBIIMNCI</div>
            <div class="input_back" id="veriNutrition">Nutrition</div>
            <div class="input_back" id="veriFCHV">FCHV</div>
            <div class="input_back" id="veriSMP">Safe Motherhood</div>
            <div class="input_back" id="veriFP">Family Planning</div>
            <div class="input_back" id="veriPHC">PHCORC</div>
            <div class="input_back" id="veriLeprosy">Leprosy</div>
            <div class="input_back" id="veriMalaria">Malaria</div>
            <div class="input_back" id="veriTuberculosis">Tuberculosis</div>
            <div class="input_back" id="veriTAE">Tuberculosis AE</div>
            <div class="input_back" id="veriTTO">Tuberculosis TO</div>
            <div class="input_back" id="veriTPAL">Tuberculosis PAL</div>
            <div class="input_back" id="veriTDRTB">Tuberculosis DRTB</div>
            <div class="input_back" id="veriKA">Kala-azar</div>

            <div class="input_back" id="veriHIVTC">HIV T&C</div>
            <div class="input_back" id="veriHIVAE">HIV (PMTCT)</div>
            <div class="input_back" id="veriHIVSTI">HIV STI</div>
            <div class="input_back" id="veriAT">HIV ART</div>
            <div class="input_back" id="veriHIVOI">HIV/AIDS OI</div>
            <div class="input_back" id="veriGEASID">GESI</div>
            <div class="input_back" id="veriOPD">OPD</div>
            <div class="input_back" id="veriLS">Laboratory Services</div>
            <div class="input_back" id="veriHSD">Hospital Summary</div>

            <div class="input_back" id="veriPMP">Population Management</div>
        ...
        <div id="monitoring" class="display" align="left" style="display:none">
            <div class="input_back" id="monRep"> Reporting Status</div>
            <div class="input_back" id="monIMM"> Immunization</div>
            <div class="input_back" id="monIMCI"> CBIIMNCI</div>
            <div class="input_back" id="monNutrition"> Nutrition</div>
            <div class="input_back" id="monFCHV"> FCHV</div>
            <div class="input_back" id="monSMH"> Safe Motherhood</div>
            <div class="input_back" id="monFP"> Family Planning</div>
            <div class="input_back" id="monPhorc"> PHCORC</div>
            <div class="input_back" id="monLeprosy"> Leprosy</div>
            <div class="input_back" id="monMalaria"> Malaria</div>
            <div class="input_back" id="monTub"> Tuberculosis</div>
            <div class="input_back" id="monHIV"> HIV/AIDS</div>
            <div class="input_back" id="monLab"> Laboratory</div>
            <div class="input_back" id=""> OPD</div>
            <div class="input_back" id="monFHS"> Free Health</div>


            <div class="parameterBack" id="sub"
                style="width:220px;background:#87CEFA;text-align:center;cursor:pointer;margin-left:520px;margin-top:20px"
                onclick="viewTree()"> Continue
            </div>
        ...
        <div id="display" class="display" style="text-align:center;margin-top:200px;">
            <div style="width:600px;margin:0 auto">
                <table>
                    <tr>
                        <td>
                            <div class="parameterBack">Report Duration</div>
                        </td>
                        <td>
                            <div class="parameterInputBack" style="width:300px;"><input type="number" id="duration"
                                    min="1" max="12" value="1" style="font-weight:bold; padding-left:3px;"
                                    oninput="validateMonths()"> <b id="monthCap"> Months </b></div>
                        </td>
                    </tr>

                    <tr>
                        <td>
                            <div class="parameterBack" style="background:#aaa">Report Starting Month</div>
                        </td>
                        <td>
                            <div class="parameterInputBack" style="width:300px;background:#aaa">
                                <select id="reportingPeriod" class="monthSel" name="reportingPeriod"
                                    style="width:200px;margin-top:0;" onchange="printMonths()">
                                ...
                                <input type="number" id="cyear" min="2060" max="2100" oninput="validateYear()"
                                    value="2073" style="font-weight:bold; padding-left:3px;">
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td valign="top">
                            <div class="parameterBack">Organisation unit</div>
                        </td>
                        <td rowspan="2">
                            <div class="parameterInputBack" style="width:300px; height:150px"
                                onmouseover="printOrgunit()">
                    ...
                    <tr>
                        <td></td>
                        <td id="btnGenerate" style='display:block'>
                            <div class="parameterInputBack"
                                style="width:300px;background:#87CEFA;text-align:center;cursor:pointer"
                                onclick="printReport()">Generate</div>
                        <td id="btnContinue" style="display:none">
                            <div class="parameterInputBack"
                                style="width:300px;background:#87CEFA;text-align:center;cursor:pointer"
                                onclick="viewVerReports()">Continue</div>
                    </tr>
                    <tr>
                        <td></td>
                        <td id="btnBack" style='display:block'>
                            <div class="parameterInputBack"
                                style="width:300px;background:#66CCFF;text-align:center;cursor:pointer"
                                onclick="goback()">Back</div>
                        </td>
                        <td id="btnCancel" style='display:none'>
                            <div class="parameterInputBack"
                                style="width:300px;background:#66CCFF;text-align:center;cursor:pointer"
                                onclick="location.reload()">Cancel</div>
                        </td>
                    </tr>
                </table>
            </div>
    ...
    <div class="NepalFooter" id="NepalFooter">
        ...
        <div class="footerOrgunit">
            ...
            <div class="footerContent"><b id="orgTitle" style="margin:0;color:#000;font-size:12px;">Not selected yet</b>
            </div>
        </div>
        ...
        <div class="footerPeriod">
            ...
            <div class="footerContent"><b id="monthTile" style="margin:0;color:#000;font-size:12px;">Not selected
                    yet</b></div>
        </div>
    </div>
    </div>
