...
export const getTEI = async orgUnit => {
    ...
    if (response.trackedEntityInstances) {
        // console.log('here is trackedEntityInstances', response.trackedEntityInstances);
        response.trackedEntityInstances.forEach((teis, index) => {
            ...
            //    console.log('here is tei id', trackedEntityInstance);
            //    console.log('here is tei orgUnit', orgUnit);
            teiRows[index] = ['', '', '', '', '', '']
