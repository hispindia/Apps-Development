...
export const getTEI = async orgUnit => {
    ...
    //api/trackedEntityInstances.json?ouMode=DESCENDANTS&ou=ANGhR1pa8I5&program=L7bu48EI54J&paging=false&lastUpdatedStartDate=2022-07-13&&lastUpdatedEndDate=2022-09-13
    ...
    let api1 = "../../../api/trackedEntityInstances.json?ouMode=DESCENDANTS&program=L7bu48EI54J&ou="+orgUnit+"&lastUpdatedStartDate=" + isoDateFormat +"&paging=false"
