...
export const eventRules = (
  ...
  // console.log("stage========", stage.programStageSections[6].dataElements[8]);
  // const event = getState().data.event.values;
  // console.log("event from rule",event);

  const getVariables = (condition) => {
    // console.log("condition testing", condition);
...
// console.log("MMMMMMAAAAAAAAAAAAAAAAAA",match)
// // Check if there is a match and get the numeric value

// console.log("CCCCCCCCCCCCCCCCCCCCCCCC",calculatedValue)
//     return {
...
//   };
  ...
  const setColors = (condition, affected, testValue) => {
    ...
    // console.log("variables============11111", variables);
  ...
  // const setColorsM = (condition, testValue) => {
    
  //   const variables1 = getVariables1(condition);
  //   const calculatedValue = variables1.calculatedValue;
  //   const dataElement = stage.dataElements[id];
  //   if(stage.programStageSections[6].dataElements[8]=="p4w4PQc42hj"){
  //    dataElement.warning="MMMMMMM"
  //   }
  //   console.log("variables============mmmm", calculatedValue);
  // };

 
  rules.forEach((rule) => {
    // console.log("ruleeeeeeeeeeeeeeeeeeeeeee============", rule);
